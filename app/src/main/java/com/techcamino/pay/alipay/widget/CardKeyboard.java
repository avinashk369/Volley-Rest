...
public class CardKeyboard extends LinearLayout implements View.OnClickListener {

    // constructors
    public CardKeyboard(Context context) {
        this(context, null, 0);
    }

    public CardKeyboard(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CardKeyboard(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private CardView mButtonReset;
    private CardView mButtonEnter;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        // initialize buttons
        LayoutInflater.from(context).inflate(R.layout.card_keyboard, this, true);
        ...
        mButtonDelete = (CardView) findViewById(R.id.btn_x);
        mButtonEnter = (CardView) findViewById(R.id.btn_y);
        mButtonReset = (CardView) findViewById(R.id.btn_z);
